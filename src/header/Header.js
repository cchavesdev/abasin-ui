            ...
            <div class="popup-container" id="popupContainer">
                <div class="nav-container">
                    <ul class="primary-nav">
                        <li class="primary-nav-option active" id="explore">Explore</li>
                        <li class="primary-nav-option" id="visit">Visit</li>
                        <li class="primary-nav-option " id="engage">Engage</li>
                        <li class="primary-nav-option " id="tickets">Tickets</li>
                    </ul>
                ...
                <div class="widget-container">
                    <div class="options">
                        <ul>
                            <li class="widget-option active" id="snow">Snow Fall</li>
                            <li class="widget-option" id="weather">Weather</li>
                            <li class="widget-option" id="terrain">Terrain Status</li>
                        </ul>
                    </div>
                    <div class="option-detail active" data-option="snow">
